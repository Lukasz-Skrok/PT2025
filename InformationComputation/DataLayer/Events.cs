...
namespace DataLayer
{
    ...
    public abstract class DataAPI
    {
        ...
        public abstract bool CheckFunds(double price);
        public abstract void IncreaseStock(string prod_name, int amount);
        public abstract void RecordProfit(double money);
    ...
    public class Events : DataAPI
    {
        ...
        public override double GetPrice(string name) => catalog.GetPrice(name);
        public override bool CheckStorage(string prod_name, int amount) => store.CheckStorage(prod_name, amount);
        public override bool CheckFunds(double price) => store.CheckFunds(price);
        public override void IncreaseStock(string name, int amount) => store.IncreaseStock(name, amount);
        public override void RecordProfit(double money) => store.RecordProfit(money);
        public override void AddItem(string name, double price) => catalog.AddItem(name, price);
        ...
        public double GetFunds() => store.GetFunds();
